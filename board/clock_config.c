...
{
    BOARD_BootClockFRO12M_PLL_150MHz();
}
...
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
!!Configuration
name: BOARD_BootClockFRO12M_PLL_150MHz
...
- {id: SYSCON.PLL0DIV.scale, value: '2', locked: true}
...
/*******************************************************************************
 * Variables for BOARD_BootClockFRO12M_PLL_150MHz configuration
 ******************************************************************************/
/*******************************************************************************
 * Code for BOARD_BootClockFRO12M_PLL_150MHz configuration
 ******************************************************************************/
void BOARD_BootClockFRO12M_PLL_150MHz(void)
{
    ...
    SystemCoreClock = BOARD_BOOTCLOCKFRO12M_PLL_150MHZ_CORE_CLOCK;
#endif
}
